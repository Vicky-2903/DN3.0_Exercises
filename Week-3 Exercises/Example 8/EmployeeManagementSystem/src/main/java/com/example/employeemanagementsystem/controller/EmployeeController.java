...
public class EmployeeController {
    ...
    @GetMapping("/search/findByDepartmentNameWithPagination")
    public Page<Employee> getEmployeesByDepartmentNameWithPagination(
    ...
    public ResponseEntity<List<EmployeeSummary>> getEmployeeSummaries(@RequestParam String departmentName) {
        List<EmployeeSummary> summaries = employeeRepository.findEmployeeSummariesByDepartmentName(departmentName);
